/**
 * k6 Performance Suite: Stress Test Scenario (Enhanced)
 * Tests application stability and breaking point under heavy concurrent load (1000 to 2000 VUs).
 * Uses a branching behavior model (not all users book a ticket) for realistic traffic.
 * Run: k6 run --env BASE_URL="http://sonyabus-app.test" k6/scenarios/stress.js
 */
...
export const options = {
    stages: [
        ...
        { duration: '2m', target: 2000 },  // Scale up to 2000 VUs (stress limit)
        { duration: '3m', target: 2000 },  // Hold at 2000 VUs for 3 minutes
        { duration: '2m', target: 0 },     // Ramp down to 0 VUs
    ],
    thresholds: {
        http_req_failed: ['rate<0.15'],     // Accept up to 15% failure under extreme stress
        http_req_duration: ['p(95)<3000'],   // 95% of requests must complete under 3.0s under stress
    },
};
